...
/****** Object:  Database [EventManager]    Script Date: 02/04/2021 19.53.48 ******/
CREATE DATABASE [EventManager]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'EventManager', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\EventManager.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'EventManager_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\EventManager_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [EventManager] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
